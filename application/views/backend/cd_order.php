					...
					<div class="span12"> 
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="#">compact disk Order's Data</a>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<h4><i class="icon-edit"></i>compact disk Order's Data</h4>
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
 									...
 									<?php foreach($cd_order as $data) { ?>

										<tr class="">

											<td><?php echo $data->user_name ?></td>

											<td><?php echo $data->cd_name ?></td>

											<td><?php echo $data->cd_language ?></td>

											<td><?php echo $data->purchase_date ?></td>
											
											<td><?php echo $data->cd_price ?></td>
